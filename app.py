...
import encrypt # Import your encryption script
...
if st.button("Encrypt"):
    if plain_text:
        encrypted_text = encrypt.encrypt(plain_text)  # Use the function from encryption.py
...
if st.button("Decrypt"):
    if cipher_text:
        decrypted_text = encrypt.decrypt(cipher_text)  # Use the function from encryption.py
